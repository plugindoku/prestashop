...
<br />
<p>
    {l s='Your order on' mod='dokuonecheckout'} <b>{$shop_name}</b> <b>{l s='is on verification.' mod='dokuonecheckout'}</b>
	  <br />
    <br />
	  ...
	  <br />
    <br />		
    {l s='We will process your order immediately after we have finished the verification.' mod='dokuonecheckout'}
    <br />
    <br />
