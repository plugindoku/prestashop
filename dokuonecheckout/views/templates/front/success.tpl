...
<br />
<p>
    {l s='Your order on' mod='dokuonecheckout'} <b>{$shop_name}</b> <b>{l s='is COMPLETE.' mod='dokuonecheckout'}</b>
	  <br />
    <br />
	  ...
	  <br />
    <br />		
    {l s='We will process your order immediately.' mod='dokuonecheckout'}
    <br />
    <br />
